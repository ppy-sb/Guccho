...
export type Extends<CmpLhs, CmpRhs> = () => CmpLhs extends CmpRhs
  ? true
  : false
export type IF<
  _Cmp extends Extends<any, any>,
  R extends THEN<unknown, unknown>
...
export type TRY<T, C extends CATCH<unknown, any>> = T extends C['catch']
  ? C['then']
  : T

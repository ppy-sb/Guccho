...
import { type Dan, type DatabaseDan, type DatabaseDanCollection, type Requirement } from '~/def/dan'
...
export abstract class DanProvider<Id, ScoreId> extends Mixin(IdTransformable, ScoreIdTransformable) {
  ...
  abstract searchCollections(opt: DanProvider.SearchParam): Promise<PaginatedResult<DatabaseDanCollection<Id>>>

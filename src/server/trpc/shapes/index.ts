...
export const zodOverallRankingSystem = z.union([zodPPRankingSystem, zodScoreRankingSystem])
export const zodRankingSystem = z.union([zodPPRankingSystem, z.literal('score')])

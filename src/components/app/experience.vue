  ...
  <div class="fixed bottom-0 w-full bg-gradient-to-b from-kimberly-100 to-kimberly-150 dark:from-kimberly-800 dark:to-kimberly-900 px-2 border-t-2 border-kimberly-200 font-mono flex items-end gap-1">
    <div class="flex flex-col md:flex-row gap-1">
      ...
      <div class="flex gap-1 items-center">
        <FontAwesomeIcon v-if="charging" icon="fa-solid fa-charging-station" />
        <FontAwesomeIcon
          :icon="
            level >= 0.875
...
import { useFps, useMemory, useBattery } from '@vueuse/core'
import { faChargingStation, faBatteryFull, faBatteryThreeQuarters, faBatteryHalf, faBatteryQuarter, faBatteryEmpty } from '@fortawesome/free-solid-svg-icons'

<template>
  <div class="container mx-auto h-header">
    ...
    <div class="grid mt-4 sm:mt-0 gap-1 sm:gap-1">
      <div class="flex justify-center">
        <a
          ...
          class="h-mode !px-4"
          :class="{
            '!opacity-80 pointer-events-none': leaderboard.mods.selected.name === m.name,
      ...
      <div class="flex justify-center">
        <a
          ...
          :class="{
            ...
            '!opacity-10 pointer-events-none': $forbiddenMode(leaderboard.mods.selected.icon, m.icon)
          }"
...
.h-header {
  @apply sm:flex mt-2 items-center justify-between text-center text-white;
  /* @apply sm:flex sm:w-full mt-2 items-center justify-between text-center text-white ; */
